...
(56, 51, NULL, '', 4, NULL, 0, '2016-06-23 07:35:25'),
(57, 51, NULL, '', 3, NULL, 0, '2016-06-23 07:35:25');
...
(1, 'Sam', '332532dcfaa1cbf61e2a266bd723612c', 2, 1, '2016-04-07 07:21:27', '2016-04-07 05:31:14', 'Dr. Sam Me', 'c4ca4238a0b923820dcc509a6f75849b', NULL, NULL),
(2, 'mary', 'b8e7be5dfa2ce0714d21dcfc7d72382c', 3, 1, '2016-04-07 08:41:57', '2016-04-07 04:08:09', 'Mary Mary', NULL, NULL, NULL),
(3, 'Doe', 'doe', 4, 1, '2016-04-07 08:42:45', '2016-04-07 03:22:06', 'Doe Doe', NULL, NULL, NULL);
...
--
ALTER TABLE `tbl_doctors`
  MODIFY `doctor_id` bigint(255) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbl_lab_requests`
  MODIFY `request_id` bigint(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
...
--
ALTER TABLE `tbl_notifications`
  MODIFY `notification_id` bigint(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=49;
--
...
--
ALTER TABLE `tbl_patients`
  MODIFY `patient_id` bigint(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
